...
using KeyBlazorNoJS.Data;

namespace KeyBlazorNoJS.Components.Account;
    ...
    : RevalidatingServerAuthenticationStateProvider(loggerFactory)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await ValidateSecurityStampAsync(userManager,
        ...
        UserManager<ApplicationUser> userManager, ClaimsPrincipal principal)
    {
        ...
        {
            var principalStamp =
                principal.FindFirstValue(options.Value.ClaimsIdentity
